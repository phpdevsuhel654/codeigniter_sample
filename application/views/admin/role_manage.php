...
<div class="card mb-3">
  <div class="card-header">              
    <i class="fas fa-table"></i>&nbsp;Roles Details              
  </div>
  <div class="card-body">
    <div class="pb-3"><a href="<?php echo site_url('admin/roles/insert'); ?>" class="btn btn-primary">Add Role</a></div>
            ...
            <?php foreach($sort_cols as $field_name => $field_display): ?>
                <th>
                  <?php
                    ...
                    echo anchor('admin/roles/index/'.$field_name.'/'.$cur_field_sort_order.'/'.$search_string.'/'.$page, $field_display);
        ...
        <tbody>
          ...
          ?>
            <tr>
              ...
              <td>
                <a href="<?php echo site_url('admin/roles/view/') . $row->id; ?>" class="icon_color"><i class="fas fa-eye"></i></a>&nbsp;
                <a href="<?php echo site_url('admin/roles/update/') . $row->id; ?>" class="icon_color"><i class="fas fa-edit"></i></a>&nbsp;
                <a href="<?php echo site_url('admin/roles/delete/') . $row->id; ?>" class="icon_color" onclick="if(!confirm('Are you sure you want to delete this?')) { return false; }"><i class="fas fa-window-close"></i></a>
              </td>
            </tr>
          <?php
            }
